...
interface DialogFormButtonConfirmation {
  onConfirm?: (dialogButtonType: DialogButtonType) => void
}
...
type ConfirmationHandlingFormButton = FormButton & DialogFormButtonConfirmation

// .... НЕТ, не надо писать все эти диалоги формы кнопки,  описываем чисто типы сейчас.
